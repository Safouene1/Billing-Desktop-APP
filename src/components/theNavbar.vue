<template>
      ...
      <div class="col-sm-auto sidebar sticky-top">
        <div class="d-flex flex-sm-column flex-row flex-nowrap  align-items-center sticky-top">
          ...
          <ul class="mt-5 nav nav-pills  flex-sm-column flex-row flex-nowrap mb-auto mx-auto text-center align-items-center">
            <router-link :to="{name:'Invoice'}" class="nav-item rounded">
              <li class="py-2 px-2">
